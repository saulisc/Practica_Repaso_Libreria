...
<script>
    Swal.fire({
        ...
        imageWidth: 400,
        imageHeight: 200,
        text: ' Cliente "{{ session('guardado')['cliente'] }}" guardado con exito',
        icon: 'success',
...
@endif
    ...
    <div class="container  col-md-6">
        <br>
        <a href="{{ route('clientes.indexClientes') }}" class="btn btn-success m-1">Ver clientes</a>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <br>
                    <form method="POST" action="{{ route('clientes.storeCliente') }}">
                    @csrf
                    <div class="row mb-3">
